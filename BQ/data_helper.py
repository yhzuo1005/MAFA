...
train_q1, train_q2, train_q3, train_q4, train_label = read_data('./data/ch_input/BQ_train_char_word.txt')
test_q1, test_q2, test_q3, test_q4, test_label = read_data('./data/ch_input/BQ_test_char_word.txt')
dev_q1, dev_q2, dev_q3, dev_q4, dev_label = read_data('./data/ch_input/BQ_dev_char_word.txt')
